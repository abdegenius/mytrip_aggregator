...
let api = `http://gds-stg.ticketsimply.africa/gds/api/`
let key = `TSBRHTAPI36224670`
module.exports = fp(async function (fastify, opts) {
  fastify.decorate('TestABCCheckTrips', async function (payload) {
    try{
        const ABC_STATES = {
            "ABIA": [
                "ABA", 
  ...
  fastify.decorate('TestABCBookTrip', async function (payload) {
    let customer = [];
